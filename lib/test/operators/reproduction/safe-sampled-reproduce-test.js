...
const safe_sampled_reproduce_1 = require("../../../src/operators/reproduction/safe-sampled-reproduce");
require("mocha");
describe('operators', () => {
    describe('reproduction', () => {
        describe('safeSampledReproduce', () => {
            ...
            let offspring = safe_sampled_reproduce_1.safeSampledReproduce(genome, mutant, nsFitness, mutateChance = mutateChance);
