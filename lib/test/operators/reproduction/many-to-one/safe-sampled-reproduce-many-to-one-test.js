...
const safe_sampled_reproduce_many_to_one_1 = require("../../../../src/operators/reproduction/many-to-one/safe-sampled-reproduce-many-to-one");
...
describe('operators', () => {
    describe('reproduction', () => {
        describe('safeSampledReproduceManyToOne', () => {
            ...
            let offspring = safe_sampled_reproduce_many_to_one_1.safeSampledReproduceManyToOne(genomes, nsFitness);
            let t = top_1.top(genomes, nsFitness, 0.5);
            let offspringFitness = nsFitness(offspring).fitness;
            let avgFitness = _.meanBy(t, e => e.fitness);
            let b = best_1.best(genomes, nsFitness);
