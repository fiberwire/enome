...
import { Gene, refresh } from "../../src/index";
    ...
    describe("genome", () => {
        ...
        describe("constructor", () => {
            ...
            it("should generate a sequence", () => {
                expect(genome.sequence.length).to.eql(genome.options.genomeLength * genome.options.geneLength);
            });
        ...
        describe("nucleotides", () => {
            it("should produce genes from the sequence", () => {
                expect(genome.freshGenes.length)
