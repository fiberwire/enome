...
import { Evaluation, Genome, GenomeOptions, NaturalSelectionOptions } from '../index';
export declare class NaturalSelection<T extends GenomeOptions, U extends NaturalSelectionOptions, V> {
    popOptions: U;
    genOptions: T;
